...
import fr.klaivert.orderofobsidian.entity.variant.RaccoonVariant;
    ...
    public static final Map<RaccoonVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(RaccoonVariant.class), (p_114874_) -> {
                p_114874_.put(RaccoonVariant.DEFAULT,
                        new ResourceLocation(OrderOfObsidianMod.MOD_ID, "textures/entity/raccoon/raccoon.png"));
                p_114874_.put(RaccoonVariant.DARK,
                        new ResourceLocation(OrderOfObsidianMod.MOD_ID, "textures/entity/raccoon/raccoondark.png"));
                p_114874_.put(RaccoonVariant.RED,
                        new ResourceLocation(OrderOfObsidianMod.MOD_ID, "textures/entity/raccoon/redraccoon.png"));
            });
