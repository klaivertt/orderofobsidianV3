package fr.klaivert.orderofobsidian.integration;

public class GemCuttingStationRecipeCategory { // implements IRecipeCategory<GemCuttingStationRecipe> {
    //public final static ResourceLocation UID = new ResourceLocation(OrderOfObsidianMod.java.MOD_ID, "gem_cutting");
    //public final static ResourceLocation TEXTURE =
    //        new ResourceLocation(OrderOfObsidianMod.java.MOD_ID, "textures/gui/gem_cutting_station_gui.png");
//
