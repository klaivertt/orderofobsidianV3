...
public abstract class FaradayArmor extends ArmorItem {
	public FaradayArmor(EquipmentSlot slot, Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(ModItems.ALUMINIUM_PLATE.get()));
			}
	...
	public static class Helmet extends FaradayArmor {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "orderofobsidian:textures/models/armor/faraday_layer_1.png";
		}
	}

	public static class Chestplate extends FaradayArmor {
		public Chestplate() {
	...
	public static class Leggings extends FaradayArmor {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "orderofobsidian:textures/models/armor/faraday_layer_2.png";
		}
	}

	public static class Boots extends FaradayArmor {
		public Boots() {
