...
public abstract class ObsidianArmor extends ArmorItem {
	public ObsidianArmor(EquipmentSlot slot, Properties properties) {
	...
	public static class Helmet extends ObsidianArmor {
		public Helmet() {
	...
	public static class Chestplate extends ObsidianArmor {
		public Chestplate() {
	...
	public static class Leggings extends ObsidianArmor {
		public Leggings() {
	...
	public static class Boots extends ObsidianArmor {
		public Boots() {
