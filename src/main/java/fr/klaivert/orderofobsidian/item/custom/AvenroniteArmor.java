...
public abstract class AvenroniteArmor extends ArmorItem {
	public AvenroniteArmor(EquipmentSlot slot, Properties properties) {
	...
	public static class Helmet extends AvenroniteArmor {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "orderofobsidian:textures/models/armor/avenronite_armor_layer_1.png";
		}
	}

	public static class Chestplate extends AvenroniteArmor {
		public Chestplate() {
	...
	public static class Leggings extends AvenroniteArmor {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "orderofobsidian:textures/models/armor/avenronite_armor_layer_2.png";
		}
	}

	public static class Boots extends AvenroniteArmor {
		public Boots() {
