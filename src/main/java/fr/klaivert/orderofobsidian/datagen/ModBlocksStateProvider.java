...
import fr.klaivert.orderofobsidian.block.custom.CucumberPlantBlock;
...
public class ModBlocksStateProvider extends BlockStateProvider {
    public ModBlocksStateProvider(DataGenerator gen, ExistingFileHelper exFileHelper) {
        super(gen, OrderOfObsidianMod.MOD_ID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlock((DoorBlock) ModBlocks.EBONY_DOOR.get(), new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/ebony_door_bottom"),
                new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/ebony_door_top"));
        trapdoorBlock((TrapDoorBlock) ModBlocks.EBONY_TRAPDOOR.get(), blockTexture(ModBlocks.EBONY_TRAPDOOR.get()), true);

        doorBlock((DoorBlock) ModBlocks.DEEPSLATE_DOOR.get(), new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/deepslate_door_bottom"),
                new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/deepslate_door_top"));
        trapdoorBlock((TrapDoorBlock) ModBlocks.DEEPSLATE_TRAPDOOR.get(), blockTexture(ModBlocks.EBONY_TRAPDOOR.get()), true);
        ...
        axisBlock((RotatedPillarBlock) ModBlocks.STRIPPED_EBONY_LOG.get(), new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/stripped_ebony_log"),
                new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/stripped_ebony_top"));
        axisBlock((RotatedPillarBlock) ModBlocks.STRIPPED_EBONY_WOOD.get(), new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/stripped_ebony_log"),
                new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/stripped_ebony_top"));
        ...
        makeCrop((CucumberPlantBlock)ModBlocks.RICE_PLANT.get(), "rice_stage", "rice_stage");
    }
    ...
    private ConfiguredModel[] states(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(block.getAgeProperty()),
                new ResourceLocation(OrderOfObsidianMod.MOD_ID, "block/" + textureName + state.getValue(block.getAgeProperty()))));
